      ...
      <main>
        ...
        <section id="projects" class="projects">
          <div class="project-tile">
            ...
            <a href="https://codepen.io/deannatrace/full/LYzdvbB">
              My Documention Project
            </a>
          </div>
          <div class="project-tile">
          ...
          <div class="project-tile">
            ...
            <a href="https://codepen.io/deannatrace/full/LYzdejX">
        ...
        <section id="profile-section" class="profile">
          <a
            id="profile-link"
            target="_blank"
            href="https://github.com/deanna-og"
          >
            <img
              id="profile link 1"
              class="profile-image"
          ...
          <a
            id="profile-link"
            target="_blank"
            href="https://www.linkedin.com/in/deannagtrace/"
          >
            <img
              id="profile link 2"
              class="profile-image"
          ...
          <a
            id="profile-link"
            target="_blank"
            href="https://codepen.io/deannatrace/"
          >
            <img
              id="profile link 3"
              class="profile-image"
              src="https://www.svgrepo.com/show/332020/codepen-circle.svg"
            ></img>
          </a>
        </section>
      </main>
